import PresentationBase from "./PresentationBaseClass";
 ...
 */
class PresenterView extends PresentationBase {
    ...
    _createBackground(slide) {
        ...
        ImgObj.src = `file://${this.basePath}/${slide.videoFile.replace(".mp4", ".png")}`
        return ImgObj
    }
    ...
    #createSlideSidebarPreview(slide) {
        ...
        slideThumbPreview.src = `file://${this.basePath}/${slide.videoFile.replace(".mp4", ".png")}`;
    ...
    #createLyricsPreview(slide) {
        let lyricsLines = slide.splitText({mode: this._mode, sepBy: this._sepBy});
    ...
    constructor(props) {
        ...
        console.log(this.#sideBarSlidesContainer, addSlideBtn);
